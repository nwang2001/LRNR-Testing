            ...
            <div className="cards">
                <div className="flip">
                    <div className="front" src="background-image: url(https://images.pexels.com/photos/540518/pexels-photo-540518.jpeg?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb)">
                        <h1 className='gradient-text'>Rewards</h1>
                    </div>
                    <div className="back">
                ...
                <div className="flip">
                    <div className="front" src="background-image: url(https://images.pexels.com/photos/414171/pexels-photo-414171.jpeg?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb)">
                        <h1 className='gradient-text'>Personal SME</h1>
                    </div>
                    <div className="back">
                        <p className='center-cards'>Welcome to the path of knowledge. Our app is like having a personal subject matter expert at your side, guiding you on your journey towards wisdom.</p>
                    </div>
                </div>
                <div className="flip">
                    <div className="front" src="background-image: url(https://images.pexels.com/photos/36717/amazing-animal-beautiful-beautifull.jpg?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb)">
                        <h1 className='gradient-text'>Personalized Quizzes</h1>
                    </div>
                    <div className="back">
                        <p className='center-cards'>Good tools make application development quicker and easier to maintain than if you did everything by hand.</p>
                    </div>
                </div>
            </div>
        </div>
