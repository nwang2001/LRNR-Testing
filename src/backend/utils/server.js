...
app.post('/generate-quiz-questions', async (req, res) => {
    ...
    console.error(error);
    res.status(500).json({ error: 'An error occurred while generating the quiz questions.' });
}
});
